...
targets_analysis <- c(
  ...
  tar_target(
    ...
    list(canopy_vsmpe_brms_sample_prior, canopy_tr_brms_sample_prior, fireflies_vsmpe_brms_sample_prior, sr_vsmpe_brms_sample_prior,
         ...
         pn_vsmpe_brms_sample_prior, pn_tr_brms_sample_prior, pi_vsmpe_brms_sample_prior, pi_tr_brms_sample_prior, temp_vsmpe_brms_sample_prior,
         temp_tr_brms_sample_prior, ta_vsmpe_brms_sample_prior, ta_tr_brms_sample_prior, dbh_vsmpe_brms_sample_prior, dbh_tr_brms_sample_prior, 
