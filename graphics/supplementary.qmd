...
![](graphics/mtl_dags_eb.png)
Figure S1. DAGs that indicate the system assumptions for ecological benefits measured in this study. Blue indicates the response variable of interest, green indicates the variable of interest and all variables adjusted for. 

![](graphics/mtl_dags_es.png)
...
lapply(seq_along(tr), function(x){
